      ...
      <main role="main" class="page-header">
        ...
        <section>
          <div class="container pt-5">
            <div class="row">
              <div class="col">
                <h1 class="text-center">Solar Installers Near Me</h1>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col">
                <!-- map -->
                <svg xmlns="http://www.w3.org/2000/svg" id="map" viewBox="0 0 959 593">
                  <title>Solar Installers Near Me</title>
                  <defs>
...
<g id="DC">
  ...
  <circle id="DC2" stroke="#FFFFFF" stroke-width="1.5" cx="801.3" cy="251.8" r="5"
  opacity="1" /> <!-- Set opacity to "0" to hide DC circle -->
</g>
</g>
<path id="frames" fill="none" stroke="#A9A9A9" stroke-width="0"
...
<ul class="list-of-states pb-5">
  <li data-state="CA"><a href="<?php get_home_url(); ?>/california-solar-installation/"
    title="California Solar Installers">California Solar Installers</a></li>
    <li data-state="CO"><a href="<?php get_home_url(); ?>/colorado-solar-installation/"
      title="Colorado Solar Installers">Colorado Solar Installers</a></li>
      <li data-state="CT"><a href="<?php get_home_url(); ?>/connecticut-solar-installation/"
        title="Connecticut Solar Installers">Connecticut Solar Installers</a></li>
        <li data-state="MA"><a href="<?php get_home_url(); ?>/massachusetts-solar-installation/"
          title="Massachusetts Solar Installers">Massachusetts Solar Installers</a></li>
          <li data-state="NJ"><a href="<?php get_home_url(); ?>/new-jersey-solar-installation/"
            title="New Jersey Solar Installers">New Jersey Solar Installers</a></li>
          </ul>
          <!-- content -->
          <?php the_content(); ?>
        </div>
...
<script>
            //Click on State and go to state url
            jQuery("#CA").click(function (e) {
              e.preventDefault();
              window.location = "<?php get_home_url(); ?>/california-solar-installation/";
            });
            jQuery("#CO").click(function (e) {
              e.preventDefault();
              window.location = "<?php get_home_url(); ?>/colorado-solar-installation/";
            });
            jQuery("#CT").click(function (e) {
              e.preventDefault();
              window.location = "<?php get_home_url(); ?>/connecticut-solar-installation/";
            });
            jQuery("#MA").click(function (e) {
              e.preventDefault();
              window.location = "<?php get_home_url(); ?>/massachusetts-solar-installation/";
            });
            jQuery("#NJ").click(function (e) {
              e.preventDefault();
              window.location = "<?php get_home_url(); ?>/new-jersey-solar-installation/";
            });
          </script>